...
/* @var $category_classifieds common\models\CategoryClassified */
/* @var $pages \yii\data\Pagination */

$this->title = Yii::t('backend', 'Category classifieds');
...
<section class="content-header">
    <div class="page-heading page-heading-md">
        <h2 class="header__main">
            ...
            <span class="title">
                <?= Yii::t('backend', 'Category classifieds') ?>
            </span>
        </h2>
    </div>
</section>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><?= Yii::t('backend', 'Can exported') ?></th>
                                    <th><?= Yii::t('backend', 'Exported') ?></th>
                                    <th><i class="fa fa-download"></i></th>
                                    <th><?= Yii::t('backend', 'Action') ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php foreach ($category_classifieds as $key => $value): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= Classified::find()->where(['category_classified_id' => $value['id']])->andWhere(['exported' => Classified::CAN_EXPORT])->count() ?>
                                        </td>
                                        <td>
                                            <?= Classified::find()->where(['category_classified_id' => $value['id']])->andWhere(['exported' => Classified::EXPORTED])->count() ?>
                                        </td>
                                        <td>
                                            <a href="<?= Url::to(['export', 'id' => $value['id']]) ?>">
